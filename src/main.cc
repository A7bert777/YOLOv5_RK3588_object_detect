...
int main(int argc, char **argv)
{
    ...
    // ---------- 修改这里的路径为你自己的路径 ----------
    const std::string modelPath = "/home/firefly/GitHUb测试/YOLOv5_RK3588_object_detect/model/yolov5_rknn7.0_best.rknn";
    const std::string imageFolder = "/home/firefly/GitHUb测试/YOLOv5_RK3588_object_detect/inputimage";
    const std::string outputFolder = "/home/firefly/GitHUb测试/YOLOv5_RK3588_object_detect/outputimage";
    // ----------------------------------------------
    ...
    ret = init_yolov5_model(modelPath.c_str(), &rknn_app_ctx);
    if (ret != 0)
    {
    ...
    std::cout << "------------------------------------------------------------------------\n";
    std::cout << "init_yolov5_model took: " << elapsed_init.count() << " ms\n";
    std::cout << "------------------------------------------------------------------------\n";
